...
async def build(ops_test: OpsTest, request):
...
@pytest.mark.abort_on_fail
async def test_relate_and_wait_for_active_status(ops_test: OpsTest, build):
    assert ops_test.model
...
@pytest.mark.abort_on_fail
async def test_remove_nrf_and_wait_for_blocked_status(ops_test: OpsTest, build):
    assert ops_test.model
...
@pytest.mark.abort_on_fail
async def test_restore_nrf_and_wait_for_active_status(ops_test: OpsTest, build):
    assert ops_test.model
    await _deploy_nrf(ops_test)
...
@pytest.mark.abort_on_fail
async def test_remove_tls_and_wait_for_blocked_status(ops_test: OpsTest, build):
    assert ops_test.model
...
@pytest.mark.abort_on_fail
async def test_restore_tls_and_wait_for_active_status(ops_test: OpsTest, build):
    assert ops_test.model
...
async def test_remove_app(ops_test: OpsTest, build):
    assert ops_test.model
